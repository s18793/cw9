...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        {
            var quest = (from emp in Emps
                       join dept in Depts on emp.Deptno equals dept.Deptno select new
                       {
                           nazwisko = emp.Ename,
                           praca = emp.Job,
        ...
        public void Przyklad7()
        {
            ...
            var quest = Emps.GroupBy(emp => emp.Job).Where(emp => emp.Count() > 1).Select(emp => new
                {
                    praca = emp.Key,
